///
/// Auto-generated TCP server for optimizer: guan_optimizer
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != GUAN_OPTIMIZER_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != GUAN_OPTIMIZER_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [guan_optimizer]")
        .version("0.0.0")
        .author("John Smith")
